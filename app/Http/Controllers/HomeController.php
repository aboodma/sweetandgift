...
class HomeController extends Controller
{
    ...
    {
      if ($request->has('trend_id')) {
        $request->session()->put('trend_id', $request->trend_id);
        $trendCustomerController = new TrendCustomerController();
        $user = $trendCustomerController->store($request->trend_id);
        if(!Auth::check()){
